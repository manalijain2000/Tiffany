<div class="side-calculate">
  <div class="emi-box ">
    ...
    <button type="button" class="btn  emi-btn" onclick='redirectToContactUsPage()'>
      ...
      x="0px" y="0px" height="60px" width="60px" viewBox="0 0 612 540"  style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>
      <path fill="currentcolor" d="M361.27,35.96H150.73c-12.289,0-22.289,10-22.289,22.298V453.76c0,12.28,10,22.28,22.289,22.28H361.27 
        c12.289,0,22.289-10,22.289-22.28V58.258C383.559,45.96,373.559,35.96,361.27,35.96z M369.414,453.76  
        c0,4.473-3.653,8.118-8.144,8.118H150.73c-4.491,0-8.144-3.644-8.144-8.118v-33.282h226.828V453.76z M369.414,406.315H142.586  
          V101.73h226.828V406.315z M369.414,87.567H142.586v-29.31c0-4.491,3.653-8.135,8.144-8.135H361.27c4.491,0,8.144,3.644,8.144,
          8.135   V87.567z"/><path fill="currentcolor" d="M283.419,61.764H256c-3.903,0-7.073,3.178-7.073,7.081c0,3.903,3.169,7.081,7.073,7.081h27.419  
          c3.903,0,7.073-3.178,7.073-7.081C290.491,64.942,287.322,61.764,283.419,61.764z"/>
          <path fill="currentcolor" d="M232.882,61.764h-6.762c-3.903,0-7.073,3.178-7.073,7.081c0,3.903,3.169,7.081,7.073,7.081h6.762 
            c3.903,0,7.073-3.178,7.073-7.081C239.955,64.942,236.785,61.764,232.882,61.764z"/>
            <path fill="currentcolor"d="M236.716,448.25h39.612c3.903,0,7.073-3.178,7.073-7.081s-3.169-7.081-7.073-7.081h-39.612 
              c-3.903,0-7.073,3.178-7.073,7.081S232.813,448.25,236.716,448.25z"/></g>
        </svg>
      </i>
