...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      <h4 class="heading">Commercial Vehicle Loan Fees & Charges</h4>
      <div class="card">
          ...
          <table class="table table-striped table-hover mt-3 table-primary">
            <thead>
              <tr>
                ...
                <th> Commercial Vehicle Loan Fees & Charges </th>
                <th></th>
              </tr>
            </thead>
            <tbody>
  ...
  <div class="container mt-5">
    ...
    <p>If you are facing working capital crunch in your business or want to grow your business, our commercial
      vehicle loan is for you. Buy new vehicle or a second-hand vehicle and start a new company or boost your
      current business growth by adding more to your fleet, we are there to empower your journey. </p>
    <p>Tiffany Finance offers Commercial Vehicle Loan at an attractive interest rate ranging from 12% to 22%. Get
      estimate of your monthly EMIs and plan your finances accordingly with our Commercial Vehicle Loan
      Calculator. You can hit and try different values in the EMI calculator and can get the best option available as
      per
      your profile.</p>
