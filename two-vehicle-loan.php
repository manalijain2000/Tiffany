...
<body>
  ...
  <div class="container mt-5" id="overview">
    <div class="row">
      <div class="col-md-7 ">
        ...
        <p class="text-dark">Want To Buy your Dream New Bike or Scooter? We offer a quick two-wheeler loan at attractive
          interest rates to make your commute comfortable and faster. Now, no need to wait for public transports to
          commute, ride and travel at your own convenience whenever and wherever you want.
        </p>
        <p class="text-dark">You can explore a bike or scooter of your choice and use our Two-Wheeler EMI Calculator to
          plan your budget accordingly. We provide a flexible tenure from 12 months to 60 months for repayment of your
          EMIs so that you can very comfortably repay without any burden.
        </p>
        <p class="text-dark">Be the owner of your dream bike and apply today at Tiffany Finance for your two-wheeler
          loan. </p>
      </div>
    ...
    <div class="row feature ">
      ...
      <div class="featuresandbenefits">
        <div class="text-center ">
          <img src="img/ftwl.jpg" class="img-fluid   ">
        </div>

        <div class="mt-5 fbc">
          <div class="d-flex align-items-start">
            <img src="img/TIF.jpg" width="25px" height="25px" class="me-2">
            <div><strong> Flexible Loan Tenure : </strong>Choose a repayment period from 12 to 60 months.
            </div>
          </div>
          <BR>
          <div class="d-flex align-items-start">
            <img src="img/TIF.jpg" width="25px" height="25px" class="me-2">
            <div><strong> Attractive Interest Rates : </strong>Enjoy competitive rates from 12% to 22%.
            </div>
          </div>
          <BR>
          <div class="d-flex align-items-start">
            <img src="img/TIF.jpg" width="25px" height="25px" class="me-2">
            <div><strong> Fast Processing : </strong>Benefit from our efficient loan processing system.
            </div>
          </div>
          <br>
          <div class="d-flex align-items-start">
            <img src="img/TIF.jpg" width="25px" height="25px" class="me-2">
            <div><strong> Quick Loan Approval : </strong>Get swift approval for timely access to funds.
            </div>
          </div>
          <BR>
          <div class="d-flex align-items-start">
            <img src="img/TIF.jpg" width="25px" height="25px" class="me-2">
            <div><strong> Loan Amount : </strong> Avail loans starting from ₹50,000, with options to borrow up to ₹2
              lakhs, catering to various financial needs.
            </div>
          </div>
          <br>
          <!-- <div class="d-flex align-items-start">
  ...
  <div class="container mt-5" id="eligibilty">
    ...
    <p class="paragraph">
    At Tiffany Finance, we understand that how much a two-wheeler matters at every household in India, hence owning one gives a lot of comfort, convenience and a sense of independence. Looking at eligibility criteria is important because if you meet all the criteria, your chances of loan approval are maximized.  
    </p>
      <div class="container mt-3 d-flex justify-content-center ">
        <div class="table-responsive-sm table-responsive-md w-50 ">
          <table class="table table-bordered mb-0">
            ...
            <tbody>
              ...
              <tr>
                <th >Co-applicant Requirement</th>
                <td>Mandatory if age is 18-20 years</td>
