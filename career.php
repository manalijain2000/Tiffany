...
<body>
  ...
  <div class="container mt-5">
    ...
    <p>Working with us will elevate your professional journey with a lot of new opportunities and learning.
      ...
      collaboration, trust, and a sense of community. We work hard and have fun too. Enjoy regular teambuilding
      activities, events, and a great camaraderie among colleagues.</p>

  </div>

  <div class="container-fluid lift-at-img mt-5 mx-4 py-3 text-center" style="background:#f3f3f3;">
    ...
    <div class="row justify-content-around">
      ...
      <div class="col-md-1">
        <img src="img/life/education.png" class="w-100" alt="">
        <h5>Education</h5>
      </div>
      <div class="col-md-1">
        <img src="img/life/Innovation.png" class="w-100" alt="">
        <h5>Innovation</h5>
      </div>
      <div class="col-md-1">
        <img src="img/life/leadership.png" class="w-100" alt="">
        <h5>Leadership</h5>
      </div>
      <div class="col-md-1">
        <img src="img/life/teamwork.png" class="w-100" alt="">
        <h5>Teamwork</h5>
      </div>

      <div class="col-md-1">
        <img src="img/life/TRUST.png" class="w-100" alt="">
        <h5>Trust</h5>
      </div>
      <div class="col-md-1">
        <img src="img/life/WORK.png" class="w-100" alt="">
        <h5>Work</h5>
      </div>
          ...
          <div class="card-feel">
            <div class="content">
              <p>“Working at Tiffany Finance has been a rewarding experience. As a Recovery Manager at Tiffany
                ...
                recovering debts; we're restoring financial stability and trust. The collaborative atmosphere, strong
                leadership, and commitment to employee well-being make it an exceptional workplace. I've had the
                chance to work on exciting projects and grow in my role. Tiffany Finance not only values its employees
          ...
          <div class="card-feel">
            <div class="content">
              <p>“I found my professional home at Tiffany Finance. The company's culture, inspiring projects, and
                ...
                empowerment. I've had the opportunity to work on diverse projects and develop new skills while
          ...
          <div class="card-feel">
            <div class="content">
              <p>“I've had the privilege of being the IT Manager at Tiffany Finance and it's been an extraordinary
                ...
                genuine sense of community. It's a place where IT professionals can truly flourish and make a
                significant
                impact. I'm proud to lead a team of dedicated individuals who are always eager to embrace new
                challenges. Tiffany Finance is more than an employer; it's a platform for IT excellence.”
