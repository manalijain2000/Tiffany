         ...
         <div class="row">
            <div class="footer-col">
               ...
               <ul>
                  ...
                  <li><a href="About.php">Core Values</a></li>
                  <li><a href="About.php">Our Team</a></li>
                  <li><a href="About.php">Life at Tiffany Finance</a></li>
            ...
            <div class="footer-col second-line">
               ...
               <ul>
                  ...
                  <li><a href="commercial-vehicle-loan.php">Two Wheeler Loan</a></li>
                  <li><a href="commercial-vehicle-loan.php">Commercial Vehicle Loan</a></li>
                  <li><a href="personal-loan.php">Personal Loan</a></li>
                  <li><a href="privacy-policy.php">Business Loan</a></li>
               </ul>
            </div>
            <div class="footer-col  ">
               <h4 class="third">Useful Links</h4>
               <ul class="third">
                  <li><a href="Fair-Practice-Code.php">Fair Pratice Code</a></li>
